...
public class UserSolution {
	...
	public static void main(String[] args) {
		...
		us.updateSoldier(17317, 3);
		
		us.updateSoldier(17317, 5);
		System.out.println(Arrays.toString(teamScoreHead[2]));
		System.out.println(Arrays.toString(teamScoreTail[2]));
		us.updateSoldier(79013, 5);
		us.fire(79013);
		
		System.out.println(us.bestSoldier(2));
		System.out.println(us.bestSoldier(2));
	}
	...
	public void fire(int mID) { //O(5)
		...
		for (int score = 1; score <= MAX_SCORE; score++) { //둘다인경우
			if (teamScoreHead[mTeam][score] == mID && teamScoreTail[mTeam][score] == mID) {
	 ...
	 */
	public void updateSoldier(int mID, int mScore) { //O(5)
		int mTeam = team[mID];
		fire(mID);
	 ...
	 */
	public void updateTeam(int mTeam, int mChangeScore) { //O(5) //업데이트 하는 순서때문에 답이 안나온다 
	...
	public void updateScore(int mTeam, int prevScore, int newScore) { 
	...
	public int getNewScore(int prevScore, int mChangeScore) { 
	 ...
	 */
	public int bestSoldier(int mTeam) { //O(병사 개수)
		int maxID = 0;
